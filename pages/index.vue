...
export default {
  ...
  methods: {
    ...
    this.errored = false
    this.loading = true
      this.$axios.get('https://api.openweathermap.org/data/2.5/weather?q='+this.cityName+'&units=metric&APPID=91aefe6fafd6a1fc3321d3af931272bc')
      ...
      this.icon = "https://openweathermap.org/img/w/" + this.info[0].icon + ".png"
      })
    }
    else {
